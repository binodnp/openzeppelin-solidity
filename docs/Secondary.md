# Secondary (Secondary.sol)

View Source: [contracts/ownership/Secondary.sol](../contracts/ownership/Secondary.sol)

**↘ Derived Contracts: [Escrow](Escrow.md), [SecondaryMock](SecondaryMock.md)**
...
```js
function transferPrimary(address recipient) public undefined onlyPrimary 
```
