...
**↘ Derived Contracts: [SignerRoleMock](SignerRoleMock.md), [SignatureBouncer](SignatureBouncer.md)**.
...
- [_addSigner](#_addsigner)
- [_removeSigner](#_removesigner)

### isSigner

```js
function isSigner(address account) public view
returns(bool)
```
