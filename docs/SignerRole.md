...
View Source: [contracts/access/roles/SignerRole.sol](../contracts/access/roles/SignerRole.sol)

**↘ Derived Contracts: [SignatureBouncer](SignatureBouncer.md), [SignerRoleMock](SignerRoleMock.md)**
...
```js
struct Roles.Role private signers;
...
- [isSigner(address account)](#issigner)
- [addSigner(address account)](#addsigner)
- [renounceSigner()](#renouncesigner)
- [_addSigner(address account)](#_addsigner)
- [_removeSigner(address account)](#_removesigner)

### isSigner

```js
function isSigner(address account) public
returns(bool)
```
...
```js
function addSigner(address account) public undefined onlySigner 
```
...
```js
function renounceSigner() public undefined
```
...
```js
function _addSigner(address account) internal undefined
```
...
⤿ Overridden Implementation(s): [SignerRoleMock._removeSigner](SignerRoleMock.md#_removesigner)

```js
function _removeSigner(address account) internal undefined
```
