...
View Source: [contracts/token/ERC20/SafeERC20.sol](../contracts/token/ERC20/SafeERC20.sol)
...
```js
function safeTransfer(IERC20 token, address to, uint256 value) internal undefined
```
...
```js
function safeTransferFrom(IERC20 token, address from, address to, uint256 value) internal undefined
```
...
```js
function safeApprove(IERC20 token, address spender, uint256 value) internal undefined
```
...
```js
function safeIncreaseAllowance(IERC20 token, address spender, uint256 value) internal undefined
```
...
```js
function safeDecreaseAllowance(IERC20 token, address spender, uint256 value) internal undefined
```
