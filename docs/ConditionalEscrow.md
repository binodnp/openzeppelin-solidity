...
**↘ Derived Contracts: [RefundEscrow](RefundEscrow.md), [ConditionalEscrowMock](ConditionalEscrowMock.md)**.
...
⤿ Overridden Implementation(s): [RefundEscrow.withdrawalAllowed](RefundEscrow.md#withdrawalallowed),[ConditionalEscrowMock.withdrawalAllowed](ConditionalEscrowMock.md#withdrawalallowed)

Returns whether an address is allowed to withdraw their funds. To be
implemented by derived contracts.

```js
function withdrawalAllowed(address payee) public view
returns(bool)
```
