...
View Source: [contracts/mocks/SecondaryMock.sol](../contracts/mocks/SecondaryMock.sol)
...
- [onlyPrimaryMock()](#onlyprimarymock)

### onlyPrimaryMock

```js
function onlyPrimaryMock() public onlyPrimary 
```
