# SampleCrowdsaleToken (SampleCrowdsaleToken.sol)

View Source: [contracts/examples/SampleCrowdsale.sol](../contracts/examples/SampleCrowdsale.sol)

**↗ Extends: [ERC20Mintable](ERC20Mintable.md), [ERC20Detailed](ERC20Detailed.md)**

**SampleCrowdsaleToken**

Very simple ERC20 Token that can be minted.
It is meant to be used in a crowdsale contract.

## Constructor

```js
constructor(literal_string "Sample Crowdsale Token" undefined, literal_string "SCT" undefined, int_const 18 undefined) public
```
...
| ------------- |------------- | -----|
| undefined | literal_string "Sample Crowdsale Token" |  | 
| undefined | literal_string "SCT" |  | 
