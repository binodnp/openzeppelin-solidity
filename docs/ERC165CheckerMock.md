...
- [supportsERC165](#supportserc165)
- [supportsInterface](#supportsinterface)
- [supportsAllInterfaces](#supportsallinterfaces)

### supportsERC165

```js
function supportsERC165(address account) public view
returns(bool)
```
...
```js
function supportsInterface(address account, bytes4 interfaceId) public view
returns(bool)
```
...
```js
function supportsAllInterfaces(address account, bytes4[] interfaceIds) public view
returns(bool)
```
