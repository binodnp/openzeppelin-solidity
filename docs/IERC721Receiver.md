...
**↘ Derived Contracts: [ERC721ReceiverMock](ERC721ReceiverMock.md), [ERC721Holder](ERC721Holder.md)**.
...
⤿ Overridden Implementation(s): [ERC721ReceiverMock.onERC721Received](ERC721ReceiverMock.md#onerc721received),[ERC721Holder.onERC721Received](ERC721Holder.md#onerc721received)

Handle the receipt of an NFT

```js
function onERC721Received(address operator, address from, uint256 tokenId, bytes data) public
returns(bytes4)
```
