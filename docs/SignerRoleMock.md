...
View Source: [contracts/mocks/SignerRoleMock.sol](../contracts/mocks/SignerRoleMock.sol)
...
- [removeSigner(address account)](#removesigner)
- [onlySignerMock()](#onlysignermock)
- [_removeSigner(address account)](#_removesigner)

### removeSigner

```js
function removeSigner(address account) public undefined
```
...
```js
function onlySignerMock() public onlySigner 
```
...
⤾ overrides [SignerRole._removeSigner](SignerRole.md#_removesigner)
