...
- [checkValidSignature](#checkvalidsignature)
- [onlyWithValidSignature](#onlywithvalidsignature)
- [checkValidSignatureAndMethod](#checkvalidsignatureandmethod)
- [onlyWithValidSignatureAndMethod](#onlywithvalidsignatureandmethod)
- [checkValidSignatureAndData](#checkvalidsignatureanddata)
- [onlyWithValidSignatureAndData](#onlywithvalidsignatureanddata)
- [theWrongMethod](#thewrongmethod)
- [tooShortMsgData](#tooshortmsgdata)

### checkValidSignature

```js
function checkValidSignature(address account, bytes signature) public view
returns(bool)
```
...
```js
function onlyWithValidSignature(bytes signature) public view onlyValidSignature
```
...
```js
function checkValidSignatureAndMethod(address account, bytes signature) public view
returns(bool)
```
...
```js
function onlyWithValidSignatureAndMethod(bytes signature) public view onlyValidSignatureAndMethod
```
...
```js
function checkValidSignatureAndData(address account, bytes , uint256 , bytes signature) public view
returns(bool)
```
...
```js
function onlyWithValidSignatureAndData(uint256 , bytes signature) public view onlyValidSignatureAndData
```
