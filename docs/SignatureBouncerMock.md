...
View Source: [contracts/mocks/SignatureBouncerMock.sol](../contracts/mocks/SignatureBouncerMock.sol)

**↗ Extends: [SignatureBouncer](SignatureBouncer.md), [SignerRoleMock](SignerRoleMock.md)**

**SignatureBouncerMock**

## Functions

- [checkValidSignature(address account, bytes signature)](#checkvalidsignature)
- [onlyWithValidSignature(bytes signature)](#onlywithvalidsignature)
- [checkValidSignatureAndMethod(address account, bytes signature)](#checkvalidsignatureandmethod)
- [onlyWithValidSignatureAndMethod(bytes signature)](#onlywithvalidsignatureandmethod)
- [checkValidSignatureAndData(address account, bytes , uint256 , bytes signature)](#checkvalidsignatureanddata)
- [onlyWithValidSignatureAndData(uint256 , bytes signature)](#onlywithvalidsignatureanddata)
- [theWrongMethod(bytes )](#thewrongmethod)
- [tooShortMsgData()](#tooshortmsgdata)

### checkValidSignature

```js
function checkValidSignature(address account, bytes signature) public
returns(bool)
```
...
```js
function onlyWithValidSignature(bytes signature) public onlyValidSignature 
```
...
```js
function checkValidSignatureAndMethod(address account, bytes signature) public
returns(bool)
```
...
```js
function onlyWithValidSignatureAndMethod(bytes signature) public onlyValidSignatureAndMethod 
```
...
```js
function checkValidSignatureAndData(address account, bytes , uint256 , bytes signature) public
returns(bool)
```
...
```js
function onlyWithValidSignatureAndData(uint256 , bytes signature) public onlyValidSignatureAndData 
```
...
```js
function theWrongMethod(bytes ) public
```
...
```js
function tooShortMsgData() public onlyValidSignatureAndData 
```
