...
- [_supportsERC165](#_supportserc165)
- [_supportsInterface](#_supportsinterface)
- [_supportsAllInterfaces](#_supportsallinterfaces)
- [_supportsERC165Interface](#_supportserc165interface)
- [_callERC165SupportsInterface](#_callerc165supportsinterface)
...
```js
function _supportsERC165(address account) internal view
returns(bool)
```
...
```js
function _supportsInterface(address account, bytes4 interfaceId) internal view
returns(bool)
```
...
```js
function _supportsAllInterfaces(address account, bytes4[] interfaceIds) internal view
returns(bool)
```
...
```js
function _supportsERC165Interface(address account, bytes4 interfaceId) private view
returns(bool)
```
...
```js
function _callERC165SupportsInterface(address account, bytes4 interfaceId) private view
